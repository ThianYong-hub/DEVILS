...
import com.devils.addon.modules.autologin.AutoLoginProfile.SyncProfileData;
import com.devils.addon.modules.autologin.AutoLoginProfile.SyncPullResult;
import com.devils.addon.modules.autologin.AutoLoginProfile.SyncPushResult;
...
public final class AutoLoginSyncCodec {
    ...
    private static final String PULL_PATH = SyncDomainRoutes.CORE_PULL_PATH;
    private static final String PUSH_PATH = SyncDomainRoutes.CORE_PUSH_PATH;
    private static final String STREAM_PATH = SyncDomainRoutes.CORE_STREAM_PATH;
    private static final String STREAM_PATH_LEGACY = SyncDomainRoutes.LEGACY_STREAM_PATH;
