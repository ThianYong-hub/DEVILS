...
public final class ClipModules {
    ...
    public static class HClip extends Module {
        ...
        public HClip() {
            super(DevilsAddon.CATEGORY, "h-clip", "Shifts into block corners when surround is mined to block crystal placement.");
        }
    ...
    public static class VClip extends Module {
        ...
        public VClip() {
            super(DevilsAddon.CATEGORY, "v-clip", "Instantly clips you vertically by a configured distance.");
        }
