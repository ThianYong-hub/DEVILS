...
import com.devils.addon.modules.autologin.AutoLoginProfile.DebugChatPacketSnapshot;
...
public class AutoLogin extends Module {
    ...
    public AutoLogin() {
        super(DevilsAddon.CATEGORY, "auto-login", "Automatically sends saved /login or /reg commands matched by current username and server.");
    }
