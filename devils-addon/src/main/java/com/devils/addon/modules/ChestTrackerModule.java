...
import com.devils.addon.modules.chesttracker.ChestTrackerBridge;
import com.devils.addon.modules.chesttracker.ChestTrackerSettingsManager;
import com.devils.addon.modules.chesttracker.ChestTrackerSnapshotStore;
import com.devils.addon.modules.chesttracker.ChestTrackerStreamController;
import com.devils.addon.modules.chesttracker.ChestTrackerSyncApi;
import com.devils.addon.modules.chesttracker.ChestTrackerSupport.Snapshot;
import com.devils.addon.modules.chesttracker.ChestTrackerSupport.SyncPull;
import com.devils.addon.modules.chesttracker.ChestTrackerSupport.SyncPush;
import com.devils.addon.modules.chesttracker.ChestTrackerSupport.SyncResult;
...
public class ChestTrackerModule extends Module {
    ...
    private void openTrackerGui() {
        try {
            ...
            DevilsAddon.LOG.error("[Devils/ChestTracker] open GUI failed.", t);
        }
    }
    ...
    private void openTrackerConfig() {
        try {
            ...
            DevilsAddon.LOG.error("[Devils/ChestTracker] open config failed.", t);
        }
    }
