...
final class SpearSpoofFlightPathSearch {
    ...
    static final int STUCK_REPATH_TICKS = 12;
    ...
    SpearSpoofFlightPathSearch(SpearSpoof module, SpearSpoofFlightPathfinder pathfinder) {
        this.module = module;
