...
import com.devils.addon.modules.antiwasp.AntiWaspPathMath;
...
public class AntiWasp extends Module {
    ...
    public AntiWasp() {
        super(DevilsAddon.CATEGORY, "anti-wasp", "Elytra flight patterns (circle, square, triangle) to evade wasp attacks.");
    }
