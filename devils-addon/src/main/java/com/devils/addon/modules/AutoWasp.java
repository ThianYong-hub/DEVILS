...
import com.devils.addon.modules.autowasp.AutoWaspFlightController;
import com.devils.addon.modules.autowasp.AutoWaspPathfinder;
...
public class AutoWasp extends Module {
    ...
    public AutoWasp() {
        super(DevilsAddon.CATEGORY, "auto-wasp", "Follows a target with elytra using obstacle-aware routing.");
    }
