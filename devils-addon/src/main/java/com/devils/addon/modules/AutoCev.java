...
import com.devils.addon.modules.autocev.AutoCevActionExecutor;
import com.devils.addon.modules.autocev.AutoCevPlanner;
...
public class AutoCev extends Module {
    ...
    public AutoCev() {
        super(DevilsAddon.CATEGORY, "auto-cev", "Places obsidian and crystals for a simple, aggressive cev cycle.");
    }
