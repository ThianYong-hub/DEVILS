...
public class HighwayBuilder extends HighwayBuilderConfig {
    ...
    private void onTickSafe(TickEvent.Pre event) {
        ...
        // EChest miner cycle вЂ” run BEFORE task repopulation to avoid blueprint conflicts
        ...
        if (miner != null) {
            ...
            if (miner.isActive()) {
                if (pathfinder.isPickupActive()) {
                    // Baritone FollowProcess is collecting items вЂ” don't interfere
                } else if (pathfinder.hasMinerGoal()) {
                    // Miner needs movement вЂ” let Baritone walk
                    pathfinder.updatePathing();
                } else {
                    // Miner is placing/mining вЂ” player must stay still, stop Baritone
                    pathfinder.resetBaritone();
                }
    ...
    // в”Ђв”Ђ Public Accessors в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
