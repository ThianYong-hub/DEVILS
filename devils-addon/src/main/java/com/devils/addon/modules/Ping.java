...
import com.devils.addon.gui.screens.settings.SelectionScreens.LocalSoundSelectScreen;
import com.devils.addon.modules.ping.PingConstants;
import com.devils.addon.modules.ping.PingFormattingUtils;
import com.devils.addon.modules.ping.PingMarkerController;
import com.devils.addon.modules.ping.PingRenderController;
import com.devils.addon.modules.ping.PingSyncController;
...
public class Ping extends Module {
    ...
    public Ping() {
        super(DevilsAddon.CATEGORY, "ping", "Sends synchronized ping markers to friends with Devils addon + sync enabled.");
        autoSubscribe = false;
        runInMainMenu = true;
