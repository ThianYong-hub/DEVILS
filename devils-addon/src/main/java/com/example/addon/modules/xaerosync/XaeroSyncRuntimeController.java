        ...
        CompletableFuture.runAsync(() -> {
            ...
            if (doPull) {
                try {
                    ...
                    error = com.example.addon.shared.sync.SyncJsonUtils.formatSyncException("pull-error", throwable, XaeroSyncConstants.SYNC_ERROR_DETAIL_MAX);
                }
            }
            ...
            if (error == null && !remoteApplied && (localNeedsPush || pushRequestedByMerge)) {
                try {
                    ...
                    error = com.example.addon.shared.sync.SyncJsonUtils.formatSyncException("push-error", throwable, XaeroSyncConstants.SYNC_ERROR_DETAIL_MAX);
                }
            }
