...
import red.jackf.chesttracker.impl.gui.util.DevilsThemeRenderer;
...
public class ChestTrackerScreen extends Screen {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float tickDelta) {
        ...
        graphics.drawString(this.font, this.title, left + TITLE_LEFT, top + TITLE_TOP, DevilsThemeRenderer.titleColor(TextColours.getLabelColour()), false);
