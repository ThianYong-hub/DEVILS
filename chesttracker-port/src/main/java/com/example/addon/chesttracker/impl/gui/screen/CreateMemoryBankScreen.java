...
import com.example.addon.chesttracker.impl.gui.widget.CustomEditBox;
import com.example.addon.chesttracker.impl.gui.widget.TextWidget;
...
public class CreateMemoryBankScreen extends BaseUtilScreen {
    ...
    private void loadDefault(Button button) {
        ...
        this.idEditBox.setValue(MemoryBankAccessImpl.getDefaultMemoryBankId(coord.get()));
