...
final class BlackjackWindow {
    ...
    private static final Identifier CARD_BACK = Identifier.of("devils-addon", "textures/games/blackjack/cards/backgroundred.png");
    private static final Identifier CHIP_WHITE = Identifier.of("devils-addon", "textures/games/blackjack/chips/chipwhite.png");
    private static final Identifier CHIP_RED = Identifier.of("devils-addon", "textures/games/blackjack/chips/chipred.png");
    private static final Identifier CHIP_GREEN = Identifier.of("devils-addon", "textures/games/blackjack/chips/chipgreen.png");
    private static final Identifier CHIP_BLACK = Identifier.of("devils-addon", "textures/games/blackjack/chips/chipblack.png");
    private static final Identifier CHIP_PURPLE = Identifier.of("devils-addon", "textures/games/blackjack/chips/chippurple.png");
    private static final Identifier CHIP_YELLOW = Identifier.of("devils-addon", "textures/games/blackjack/chips/chipyellow.png");
    private static final Identifier CHIP_ORANGE = Identifier.of("devils-addon", "textures/games/blackjack/chips/chiporange.png");
    private static final Identifier CHIP_BLUE = Identifier.of("devils-addon", "textures/games/blackjack/chips/chipblue.png");
