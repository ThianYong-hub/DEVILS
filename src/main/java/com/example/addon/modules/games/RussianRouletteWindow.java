...
final class RussianRouletteWindow {
    ...
    private static final Identifier BULLET = Identifier.of("devils-addon", "textures/games/roulette/bullet.png");
    private static final Identifier PISTOL = Identifier.of("devils-addon", "textures/games/roulette/pistol.png");
    private static final Identifier SKULL_ALIVE = Identifier.of("devils-addon", "textures/games/roulette/skull_alive.png");
    private static final Identifier SKULL_LOST = Identifier.of("devils-addon", "textures/games/roulette/skull_lost.png");
