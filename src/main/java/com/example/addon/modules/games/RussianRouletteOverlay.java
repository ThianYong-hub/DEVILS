...
public final class RussianRouletteOverlay extends Module {
    ...
    private static final Identifier[] TIMER_FRAMES = {
        Identifier.of("devils-addon", "textures/games/roulette/timer_5.png"),
        Identifier.of("devils-addon", "textures/games/roulette/timer_4.png"),
        Identifier.of("devils-addon", "textures/games/roulette/timer_3.png"),
        Identifier.of("devils-addon", "textures/games/roulette/timer_2.png"),
        Identifier.of("devils-addon", "textures/games/roulette/timer_1.png")
    };
    private static final Identifier[] REAPER_FRAMES = {
        Identifier.of("devils-addon", "textures/games/roulette/reaper_1.png"),
        Identifier.of("devils-addon", "textures/games/roulette/reaper_2.png"),
        Identifier.of("devils-addon", "textures/games/roulette/reaper_3.png"),
        Identifier.of("devils-addon", "textures/games/roulette/reaper_4.png"),
        Identifier.of("devils-addon", "textures/games/roulette/reaper_5.png")
    };
    ...
    public RussianRouletteOverlay() {
        super(AddonTemplate.GAMES_CATEGORY, "russian-roulette", "Russian roulette mini-game in movable overlay.");
        runInMainMenu = true;
    }
    ...
    private void onTick(TickEvent.Post event) {
        CrashGuard.run(this, "rouletteTick", () -> {
            if (!isActive()) return;
            if (gameVisible) {
    ...
    private void onKey(KeyEvent event) {
        ...
        if (key == GLFW.GLFW_KEY_ESCAPE) {
            GamesModule.closeAllFromAny();
        }
    }

    @EventHandler
    private void onRender2D(Render2DEvent event) {
        CrashGuard.run(this, "rouletteRender", () -> {
            if (!isActive()) return;
    ...
    private void onMouse(MouseClickEvent event) {
        CrashGuard.run(this, "rouletteMouse", () -> {
            if (!isActive()) return;
            if (mc.currentScreen instanceof WidgetScreen) return;
            ...
            boolean consumed = window.onMouse(
                ...
                pinned.get(),
                this::setPinned,
                () -> GamesModule.cycleFrom(GamesModule.QuickGame.RUSSIAN_ROULETTE),
                GamesModule::closeAllFromAny
            );
    ...
    private void beginDeathSequence() {
        ...
        AddonTemplate.LOG.error("[Roulette] Death sequence started. Outcome={}", deathOutcome);
    }
