...
public final class ChessGameScreen extends Screen {
    ...
    private static final Identifier SQUARE_LIGHT = Identifier.of("devils-addon", "textures/games/chess/square_light.png");
    private static final Identifier SQUARE_DARK = Identifier.of("devils-addon", "textures/games/chess/square_dark.png");
    private static final Identifier W_KING = Identifier.of("devils-addon", "textures/games/chess/w_king.png");
    private static final Identifier W_QUEEN = Identifier.of("devils-addon", "textures/games/chess/w_queen.png");
    private static final Identifier W_ROOK = Identifier.of("devils-addon", "textures/games/chess/w_rook.png");
    private static final Identifier W_BISHOP = Identifier.of("devils-addon", "textures/games/chess/w_bishop.png");
    private static final Identifier W_KNIGHT = Identifier.of("devils-addon", "textures/games/chess/w_knight.png");
    private static final Identifier W_PAWN = Identifier.of("devils-addon", "textures/games/chess/w_pawn.png");
    private static final Identifier B_KING = Identifier.of("devils-addon", "textures/games/chess/b_king.png");
    private static final Identifier B_QUEEN = Identifier.of("devils-addon", "textures/games/chess/b_queen.png");
    private static final Identifier B_ROOK = Identifier.of("devils-addon", "textures/games/chess/b_rook.png");
    private static final Identifier B_BISHOP = Identifier.of("devils-addon", "textures/games/chess/b_bishop.png");
    private static final Identifier B_KNIGHT = Identifier.of("devils-addon", "textures/games/chess/b_knight.png");
    private static final Identifier B_PAWN = Identifier.of("devils-addon", "textures/games/chess/b_pawn.png");
    ...
    private void applySyncSnapshot(SessionView session) {
        ...
        if (!session.active()) {
            statusText = "No active chess session. Open mini-games hub to invite player.";
            clearSelection();
            return;
        }
    ...
    private void drawBottomPanel(DrawContext context, BoardMetrics board, SessionView session) {
        ...
        String modeText = mode == Mode.SYNC ? "Mode: SyncHub" : "Mode: Script";
