package com.example.addon.chesttracker.api.gui;
 ...
 * on any provider, as well as any subclasses.</p>
 *
 * <p>By default, this includes the two inventory screens (survival and creative), the beacon, and all of the workstations
 * which do not retain items.</p>
 */
