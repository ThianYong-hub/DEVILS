 ...
 * {@link com.example.addon.chesttracker.api.providers.defaults.DefaultProviderScreenClose}.</p>
 *
 ...
 * {@link com.example.addon.chesttracker.api.providers.defaults.DefaultProviderMemoryLocation}.</p>
 *
 * <p>The icons for Chest Tracker's sidebar are obtained from the default provider in
 * {@link com.example.addon.chesttracker.api.providers.defaults.DefaultProvider#getMemoryKeyIcons()}. If you want to add to the
 * default list (i.e. creating or adding support for a dimension, you can do so in
 * {@link com.example.addon.chesttracker.api.providers.defaults.DefaultIcons}.</p>
 *
 * @see com.example.addon.chesttracker.api.providers.defaults.DefaultProvider#INSTANCE
 */
package com.example.addon.chesttracker.api.providers.defaults;