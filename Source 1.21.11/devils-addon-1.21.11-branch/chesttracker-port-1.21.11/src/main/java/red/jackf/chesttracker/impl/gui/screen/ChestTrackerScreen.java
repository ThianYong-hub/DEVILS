...
public class ChestTrackerScreen extends Screen {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float tickDelta) {
        ...
        graphics.drawString(this.font, this.title, left + TITLE_LEFT, top + TITLE_TOP, DevilsThemeRenderer.titleColor(TextColours.getLabelColour()), false); // title
    ...
    public boolean keyPressed(@NotNull KeyEvent event) {
        ...
        if (!searchFocused && com.example.addon.chesttracker.impl.ChestTracker.OPEN_GUI.matches(event)) {
            this.onClose();
            return true;
        }
