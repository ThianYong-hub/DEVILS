package com.example.addon.chesttracker.api.memory.counting;

import net.minecraft.network.chat.Component;
import org.jetbrains.annotations.ApiStatus;

/**
 * <p>Stack merging method for counting methods in {@link com.example.addon.chesttracker.api.memory.MemoryKey#getCounts(CountingPredicate, StackMergeMode)}.</p>
 *
