...
import com.example.addon.chesttracker.impl.memory.metadata.CompatibilitySettings;
import com.example.addon.chesttracker.impl.memory.metadata.FilteringSettings;
import com.example.addon.chesttracker.impl.memory.metadata.IntegritySettings;
import com.example.addon.chesttracker.impl.memory.metadata.SearchSettings;
import com.example.addon.chesttracker.impl.rendering.NameRenderMode;
...
import com.example.addon.chesttracker.impl.util.I18n;
        ...
        addSetting(CycleButton.<CompatibilitySettings.NameFilterMode>builder(mode -> mode.label,
                ...
                .create(getSettingsX(0),
                        ...
                        (cycleButton, newValue) -> this.memoryBank.metadata()
                                .getCompatibilitySettings().nameFilterMode = newValue
        ...
        addSetting(CycleButton.<NameRenderMode>builder(mode -> mode.label,
                ...
                .create(getSettingsX(0),
                        ...
                        translatable("chesttracker.gui.editMemoryBank.compatibility.nameRenderMode"),
                                (cycleButton, newValue) -> this.memoryBank.metadata()
                                        .getCompatibilitySettings().nameRenderMode = newValue
                ), SettingsTab.COMPATIBILITY);
    }
