package com.example.addon.chesttracker.api.providers.context;
...
/**
 * <p>Context for when a screen is opened in {@link com.example.addon.chesttracker.api.providers.ServerProvider#onScreenOpen(ScreenOpenContext)}.</p>
 *
...
public interface ScreenOpenContext {
     ...
     *
     * @see com.example.addon.chesttracker.api.providers.InteractionTracker
     * @see com.example.addon.chesttracker.api.providers.ServerProvider#getMemoryLocation(ClientBlockSource)
