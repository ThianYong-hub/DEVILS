...
public final class AutoWaspFlightController {
    ...
    public void resetNavigationState() {
        jumpTimer = 0;
        incrementJumpTimer = false;
        lastPlayerPos = module.client().player != null ? com.example.addon.util.EntityPositionCompat.pos(module.client().player) : null;
        stuckTicks = 0;
        adaptiveHorizontalCap = -1;
        antiCheatSlowTicks = 0;
    }
    ...
    public void handleNotGliding() {
        ...
        stuckTicks = 0;
        lastPlayerPos = com.example.addon.util.EntityPositionCompat.pos(module.client().player);
        adaptiveHorizontalCap = -1;
        antiCheatSlowTicks = 0;
    }
    ...
    public void onMove(PlayerMoveEvent event, Vec3d steerTarget) {
        ...
        Vec3d safeTarget = pathfinder.adjustToSafeCorridor(steerTarget, com.example.addon.util.EntityPositionCompat.pos(module.client().player));
        Vec3d toTarget = safeTarget.subtract(com.example.addon.util.EntityPositionCompat.pos(module.client().player));
        ...
        yVel = applyVerticalSafety(yVel, com.example.addon.util.EntityPositionCompat.pos(module.client().player));

        Vec3d base = new Vec3d(xVel, yVel, zVel);
        Vec3d avoid = computeLocalAvoidance(safeTarget, base, maxHorizontal);
        Vec3d velocity = applyDimensionFlightLimit(applyEmergencyBraking(base.add(avoid)), com.example.addon.util.EntityPositionCompat.pos(module.client().player));
    ...
    private void updateStuckState() {
        ...
        Vec3d now = com.example.addon.util.EntityPositionCompat.pos(module.client().player);
    ...
    private Vec3d applyEmergencyBraking(Vec3d velocity) {
        ...
        Vec3d pos = com.example.addon.util.EntityPositionCompat.pos(module.client().player);
