...
public class PathfinderHandler {
    ...
    public void updatePathing() {
        ...
        switch (moveState) {
            ...
            case RESTOCK -> {
                ...
                if (movement.horizontalDistanceSq(com.example.addon.util.EntityPositionCompat.pos(mc.player), standTarget)
    ...
    private void updateRunning() {
        ...
        double distToCurrentSq = movement.horizontalDistanceSq(com.example.addon.util.EntityPositionCompat.pos(mc.player), Vec3d.ofCenter(currentBlockPos));
