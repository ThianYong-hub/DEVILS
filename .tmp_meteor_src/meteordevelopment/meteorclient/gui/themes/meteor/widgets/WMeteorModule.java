...
public class WMeteorModule extends WPressable implements MeteorWidget {
    ...
    protected void onPressed(int button) {
        ...
        else if (button == GLFW_MOUSE_BUTTON_RIGHT) mc.method_1507(theme.moduleScreen(module));
    }
    ...
    protected void onRender(GuiRenderer renderer, double mouseX, double mouseY, double delta) {
        ...
        animationProgress1 = class_3532.method_15350(animationProgress1, 0, 1);

        animationProgress2 += delta * 6 * (module.isActive() ? 1 : -1);
        animationProgress2 = class_3532.method_15350(animationProgress2, 0, 1);
