...
import static net.minecraft.class_310.field_1703;
...
public class MeteorGuiTheme extends GuiTheme {
    ...
    public final Setting<Double> scale = sgGeneral.add(new DoubleSetting.Builder()
        ...
        .onSliderRelease()
        .onChanged(aDouble -> {
            if (mc.field_1755 instanceof WidgetScreen) ((WidgetScreen) mc.field_1755).invalidate();
        })
        .build()
    );
    ...
    public final Setting<Boolean> hideHUD = sgGeneral.add(new BoolSetting.Builder()
        ...
        .defaultValue(false)
        .onChanged(v -> {
            if (mc.field_1755 instanceof WidgetScreen) mc.field_1690.field_1842 = v;
        })
        .build()
    );
    ...
    public double scale(double value) {
        ...
        if (field_1703) {
            scaled /= (double) mc.method_22683().method_4480() / mc.method_22683().method_4489();
        }
