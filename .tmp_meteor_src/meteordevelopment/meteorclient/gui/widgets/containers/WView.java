...
public abstract class WView extends WVerticalList {
    ...
    protected void onCalculateWidgetPositions() {
        ...
        if (moveAfterPositionWidgets) {
            scroll = class_3532.method_15350(scroll, 0, actualHeight - height);
            targetScroll = scroll;
    ...
    public boolean onMouseScrolled(double amount) {
        if (!scrollOnlyWhenMouseOver || mouseOver) {
            ...
            targetScroll = class_3532.method_15350(targetScroll, 0, actualHeight - height);
            return true;
        }
    ...
    private void updateScroll(double delta) {
        ...
        scroll = class_3532.method_15350(scroll, 0, max);
