...
public abstract class WAccount extends WHorizontalList {
    ...
    public void init() {
        ...
        if (mc.method_1548().method_1676().equalsIgnoreCase(account.getUsername())) name.color = loggedInColor();
        ...
        if (account instanceof TokenAccount) {
            ...
            info.action = () -> mc.method_1507(new AccountInfoScreen(theme, account));
        }
