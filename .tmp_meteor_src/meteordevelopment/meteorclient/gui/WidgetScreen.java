...
public abstract class WidgetScreen extends class_437 {
    ...
    public boolean method_25404(int keyCode, int scanCode, int modifiers) {
        ...
        boolean shouldReturn = root.keyPressed(keyCode, modifiers) || super.method_25404(keyCode, scanCode, modifiers);
        ...
        boolean control = class_310.field_1703 ? modifiers == GLFW_MOD_SUPER : modifiers == GLFW_MOD_CONTROL;
    ...
    public void renderCustom(class_332 context, int mouseX, int mouseY, float delta) {
        int s = mc.method_22683().method_4495();
        mouseX *= s;
        mouseY *= s;

        animProgress += delta / 20 * 14;
        animProgress = class_3532.method_15350(animProgress, 0, 1);
    ...
    private static class WFullScreenRoot extends WContainer implements WRoot {
        ...
        public boolean render(GuiRenderer renderer, double mouseX, double mouseY, double delta) {
            if (!valid) {
                ...
                valid = true;
                mouseMoved(mc.field_1729.method_1603(), mc.field_1729.method_1604(), mc.field_1729.method_1603(), mc.field_1729.method_1604());
            }
