...
public class ProxiesScreen extends WindowScreen {
    ...
    public void initWidgets() {
        ...
        newBtn.action = () -> mc.method_1507(new EditProxyScreen(theme, null, this::reload));
        ...
        importBtn.action = () -> {
            ...
            if (selectedFile != null) {
                ...
                mc.method_1507(new ProxiesImportScreen(theme, file));
            }
        };
        ...
        configButton.action = () -> mc.method_1507(new ConfigScreen(theme));
    ...
    private void initTable(WTable table) {
        ...
        for (Proxy proxy : Proxies.get()) {
            ...
            edit.action = () -> mc.method_1507(new EditProxyScreen(theme, proxy, this::reload));
