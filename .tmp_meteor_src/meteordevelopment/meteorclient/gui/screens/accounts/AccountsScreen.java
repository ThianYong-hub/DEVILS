...
public class AccountsScreen extends WindowScreen {
    ...
    public void initWidgets() {
        ...
        addButton(l, "Cracked", () -> mc.method_1507(new AddCrackedAccountScreen(theme, this)));
        addButton(l, "Altening", () -> mc.method_1507(new AddAlteningAccountScreen(theme, this)));
        addButton(l, "Microsoft", () -> mc.method_1507(new AddMicrosoftAccountScreen(theme, this)));
    }
