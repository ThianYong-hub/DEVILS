...
public class ModuleScreen extends WindowScreen {
    ...
    public boolean toClipboard() {
        ...
        tag.method_10582("name", module.name);

        class_2487 settingsTag = module.settings.toTag();
        if (!settingsTag.method_33133()) tag.method_10566("settings", settingsTag);
    ...
    public boolean fromClipboard() {
        ...
        if (!tag.method_68564("name", "").equals(module.name)) return false;
