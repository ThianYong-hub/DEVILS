...
public class ModulesScreen extends TabScreen {
    ...
    protected WWindow createSearch(WContainer c) {
        ...
        if (theme.categoryIcons()) {
            w.beforeHeaderInit = wContainer -> wContainer.add(theme.item(class_1802.field_8251.method_7854())).pad(2);
        }
    ...
    protected Cell<WWindow> createFavorites(WContainer c) {
        ...
        if (theme.categoryIcons()) {
            w.beforeHeaderInit = wContainer -> wContainer.add(theme.item(class_1802.field_8137.method_7854())).pad(2);
        }
